...
public interface AppointmentService {
    ...
    Page<AppointmentResponse> findByPhone(String value, LocalDate date, Appointment.AppointmentStatus status,
            Pageable pageable);

    Page<AppointmentResponse> findMyAppointment(LocalDate date, Appointment.AppointmentStatus status,
            Pageable pageable);
    ...
    InvalidService getInvalidServices(LocalDate date, LocalTime time, Integer serviceId);
}
